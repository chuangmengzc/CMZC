...
import com.chuangmeng.cmzc.commons.URL;
...
public class BackStageUtils {
    ...
    public static String uploadFile(MultipartFile uploadFile,DIR dir) throws IOException {
        ...
        String pathname = URL.FILEUPLOAD+dir.getDir();
        //切换ftp默认文件夹
        boolean pub1 = ftp.changeWorkingDirectory(pathname);
        //获取内存文件
        ...
        //退出登录
        ftp.logout();
        return URL.NGINXURL+dir.getDir()+filename;
    }
