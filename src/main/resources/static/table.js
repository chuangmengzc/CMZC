...
function insertRowsc(obj, k) {
	...
	for (var i = 0; i < cellsnumber; i++) {
		...
		cell.align='left';
		if(i==0){
			idstr = "packagePrice"+rowsnumber;
            type= "text";
        }
		if(i==1){
			idstr = "packageNum"+rowsnumber;
            type= "text";
        }
		if(i==2){
			idstr = "packageInfo"+rowsnumber;
            type= "text";
        }
		if(i==3){
			idstr = "packageGift"+rowsnumber;
            type= "text";
        }
		if(i==4){
			idstr = "packagePostFee"+rowsnumber;
            type= "text";
        }
        if(i==5){
            idstr = "packageReturnTime"+rowsnumber;
            type= "text";
		}
		if(i==6){
            idstr = "packagePic"+rowsnumber;
            type= "file";
		}
		if(i!=6){
		   cell.innerHTML = '<input id="'+idstr+'" onkeyup="checkVal(this);" name="'+idstr+'" style="width:80px" type="'+type+'" value="" />';
		}else{
